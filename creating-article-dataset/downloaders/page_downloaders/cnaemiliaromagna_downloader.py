...
website_url = 'https://www.cnaemiliaromagna.it/categorie/notizie/page/%d/'
...
for i in range(start_i, end_i + 1):
    ...
    file_path = "/home/marco/workspace/git/StatLearnTeam/web_pages_index/new_pages/cnaemiliaromagna_" + str(i) + ".html"
