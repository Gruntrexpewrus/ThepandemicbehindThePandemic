...
website_url = 'https://toscananews.net/%s/page/%d/'
...
for category in categories:
    ...
    for i in range(start_i, end_i):
        ...
        file_path = "/home/marco/workspace/git/StatLearnTeam/web_pages_index/new_pages/toscananews_" + category + '_' + str(i) + ".html"
