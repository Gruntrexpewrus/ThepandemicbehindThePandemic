...
website_url = 'https://www.toscana-notizie.it/archivio?p_p_id=com_liferay_asset_publisher_web_portlet_AssetPublisherPortlet_INSTANCE_Lyd2Is2gGDzu&p_p_lifecycle=0&p_p_state=normal&p_p_mode=view&_com_liferay_asset_publisher_web_portlet_AssetPublisherPortlet_INSTANCE_Lyd2Is2gGDzu_delta=55&p_r_p_resetCur=false&_com_liferay_asset_publisher_web_portlet_AssetPublisherPortlet_INSTANCE_Lyd2Is2gGDzu_cur=%d'
...
for i in range(start_i, end_i + 1):
    ...
    file_path = "/home/marco/workspace/git/StatLearnTeam/web_pages_index/new_pages/toscana-notizie_" + str(i) + ".html"
