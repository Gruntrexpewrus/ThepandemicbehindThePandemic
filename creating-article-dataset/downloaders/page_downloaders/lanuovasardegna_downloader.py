...
website_url = 'https://www.lanuovasardegna.it/%s/cronaca?page=%d'

categories = {'sassari':[41,173], 'cagliari':[12, 40], 'nuoro':[31,141]}
for category in categories:
    
    
    start_i = categories[category][0]
    end_i = categories[category][1]
    
    
    for i in range(start_i, end_i + 1):
        url = str(website_url % (category, i))
        
        
        #file_path = "/home/marco/workspace/git/StatLearnTeam/web_pages_index/new_pages/" + str(i) + ".html"
    
        file_path = "/home/marco/workspace/git/StatLearnTeam/web_pages_index/new_pages/nuovasardegna_" + category + '_' + str(i) + ".html"
        ...
        try:
            ...
            print('Downloaded %s %s.html | Size: %d Kb' % (category, str(i), file_size_kb))
