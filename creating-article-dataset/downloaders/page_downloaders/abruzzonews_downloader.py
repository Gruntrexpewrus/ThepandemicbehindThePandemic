...
website_url = 'https://www.abruzzonews.eu/%s/page/%d'

categories = {'pescara':[32, 117],
              'chieti':[19,79],
              'laquila':[15,68],
              'teramo':[18,87],
              'regione':[21,110]}
...
for category in categories:
    ...
    for i in range(start_i, end_i + 1):
        ...
        file_path = "/home/marco/workspace/git/StatLearnTeam/web_pages_index/new_pages/abruzzonews_" + category + '_' + str(i) + ".html"
