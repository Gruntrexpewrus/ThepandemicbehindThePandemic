...
website_url = 'https://www.gazzettamatin.com/gazzettamatin/category/%s/page/%d/'
...
categories = {'cronaca':[4, 18], 'attualita':[3,44]}
for category in categories:
    ...
    for i in range(start_i, end_i):
        ...
        file_path = "/home/marco/workspace/git/StatLearnTeam/web_pages_index/new_pages/aostanews_" + category + '_' + str(i) + ".html"
