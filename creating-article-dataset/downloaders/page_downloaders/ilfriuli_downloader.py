...
website_url = 'https://www.ilfriuli.it/rubrica/cronaca/2_%d.aspx'
...
for i in range(start_i, end_i + 1):
    ...
    file_path = "/home/marco/workspace/git/StatLearnTeam/web_pages_index/new_pages/ilfriuli_" + str(i) + ".html"
