...
website_url = 'https://www.umbriajournal.com/%s/page/%d/'

categories = {'cronaca':[8, 63]}
for category in categories:
    ...
    for i in range(start_i, end_i + 1):
        ...
        file_path = "/home/marco/workspace/git/StatLearnTeam/web_pages_index/new_pages/umbriajournal_" + category + '_' + str(i) + ".html"
