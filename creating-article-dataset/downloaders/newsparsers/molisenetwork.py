...
class MoliseNetworkParser:
    ...
    def _extract_article_body(self, page_content):
        ...
        for par in paragraphs:
            if 'RIPRODUZIONE RISERVATA' not in par.getText():
        ...
        found_date = soup.find('time', 'postmeta-date')['datetime']
        ...
        '''
        #print(updated_content)
        return updated_content, found_date
